...
```{r}
pop_density_df <- read_csv("/Users/nicolesorensen/Dropbox/CountyProfile.csv")
...
```
Note on graph how low, med, and high density were determined
...
```
Look at causes of local spikes, causes, policies?
